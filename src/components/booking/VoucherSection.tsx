...
export function VoucherSection() {
  return (
    <section className="border-2 border-ocean-blue/20 border-dashed rounded-[20px] p-lg flex items-center justify-between bg-surface-bright/50 relative overflow-hidden">
      ...
      <div className="w-12 h-12 rounded-full bg-ocean-blue/10 text-ocean-blue flex items-center justify-center mr-sm">
