...
## 남은 화면 (8개, Stitch 원본 기준)
인기 액티비티 전체보기 / 상품 후기 / 리뷰 작성 / 리뷰 전체보기 / 예약 및 결제 / 결제 완료 / 예약 내역 / 내 정보
...
## 다음 액션
1. 다음 화면 포팅 (WIP=1 — 한 화면씩 완전히 검증 후 진행). 추천 순서: 예약 및 결제 → 결제 완료 → 예약 내역 → 리뷰 클러스터 → 내 정보
